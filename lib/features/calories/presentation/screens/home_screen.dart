...
import 'package:cal_scanner/features/calories/presentation/widgets/meal_list.dart';
        ...
        child: Column(
          ...
          children: [
            BlocBuilder<FoodLogCubit, FoodLogState>(
              builder: (context, state) => WeekDatePicker(
                selectedDate: state.selectedDate,
                onDateSelected: (date) async {
                  await context.read<FoodLogCubit>().selectDate(date);
                },
              ),
            ),
